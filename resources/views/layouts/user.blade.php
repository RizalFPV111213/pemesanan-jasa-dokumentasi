...
<body>
    ...
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          ...
          <h2 class="d-inline text-light">Digita.id</h2>
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='blog'?'menu-active':''}}"><a href="{{url('blog')}}">Articles</a></li>
          <li><a href="#">Service</a>
            <ul>
              <li class="{{$url=='photographer'?'menu-active':''}}"><a href="{{url('photographer')}}">Photographer</a></li>
              <li class="{{$url=='videographer'?'menu-active':''}}"><a href="{{url('videographer')}}">Videographer</a></li>
              <li class="{{$url=='drone'?'menu-active':''}}"><a href="{{url('drone')}}">Drone Pilot</a></li>
            </ul>
          </li>
          <li class="{{$url=='contact'?'menu-active':''}}"><a href="{{url('contact')}}">Contact</a></li>
          <li class="{{$url=='register'?'menu-active':''}}"><a href="{{url('register')}}">Register</a></li>
        </ul>
  ...
  <footer id="footer">
    ...
    <div class="container">
      {{-- <div class="copyright">
        &copy; Copyright <strong>Kieee.</strong>. All Rights Reserved
      </div> --}}
      <div class="credits">
        Designed by <a href="https://bootstrapmade.com/">Digita.Id</a>
      </div>
    </div>
  </footer><!-- #footer -->
