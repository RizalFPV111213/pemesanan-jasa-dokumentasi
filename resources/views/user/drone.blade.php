    ...
    <div class="service-photographer">
        ...
        <div class="service-section py-5">
            <div class="container">
                <h2 class="text-center mb-5">Layanan Pilot Drone Kami</h2>
                <div class="row">
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <h5 class="card-title">Company Profile Drone</h5>
                                <p class="card-text">Membuat profile company Anda dengan sentuhan profesional</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <h5 class="card-title">Travel Video Drone</h5>
                                <p class="card-text">Video produk berkualitas tinggi untuk kebutuhan bisnis dan e-commerce</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <h5 class="card-title">Event Drone</h5>
                                <p class="card-text">Memberikan output terbaik untuk event anda</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h3 class="text-success">Rp 7.000.000</h3>
                        ...
                        <form id="bookingForm">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="selectedPackage" required>
                                    ...
                                    <option value="basic">Basic Package - Rp 2.500.000
                                        (4 Jam Sesi Foto)</option>
                                    <option value="standard">Standard Package - Rp 4.000.000
                                        (6 Jam Sesi Foto)</option>
                                    <option value="premium">Premium Package - Rp 7.000.000
